...
export const deleteUser = async (req, res, next) => {
  ...
  // 3- check role
  // 3.1-check if role is CLIENTE or LAWYER
  if (role == systemRoles.CLIENTE || role == systemRoles.LAWYER) {
...
export const getUserById = async (req, res, next) => {
  // 1- destructuring userId from the request params
